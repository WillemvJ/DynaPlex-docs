...
# The product is called plain "DynaPlex" everywhere (decided 2026-08-04: the
# "DynaPlex 2" working name clashed with the 1.x wheel versions; the rewrite
# story lives in prose, not the name).
project = "DynaPlex"
